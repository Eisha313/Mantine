...
//         useEffect(() => {
//             fetch("https://your-backend-api.com/getVehicles")
//               .then((response) => response.json())
//               .then((data) => {
//                 setVehicles(data); // Assuming the data received is an array of vehicles
//               })
//               .catch((error) => {
//                 console.error("Error fetching vehicles:", error);
//               });
//           }, [vehicles]); // Trigger useEffect whenever a new vehicle is added (vehicles state changes)
        
//           const sendDataToBackend = () => {
//             fetch("https://your-backend-api.com/addVehicle", {
//               method: "POST",
//               headers: {
//                 "Content-Type": "application/json",
//               },
